...
curl --header "Content-Type: application/json" --header "Authorization: JWT $ACCESS" -X POST --data '{"view_name": "sample_view", "sql_query": "SELECT * FROM \"1\".\"sample_table\""}' http://localhost:8000/views/create/
