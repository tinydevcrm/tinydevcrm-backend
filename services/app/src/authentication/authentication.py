...
This file is copied over and modified from:
https://raw.githubusercontent.com/SimpleJWT/django-rest-framework-simplejwt/master/rest_framework_simplejwt/authentication.py

This file is registered with Django settings
